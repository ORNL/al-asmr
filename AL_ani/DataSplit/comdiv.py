...
filename = 'tot.h5'
CombineDataConstN(flist[:flenth],filename,20)
...
for i in range(0,1):
    ...
    HDF5(mols_tr,'mol',tr_coord,tr_f,tr_en,species,tr_cell,tr_virial)
    HDF5(mols_val,'mol',val_coord,val_f,val_en,species,val_cell,val_virial)    
