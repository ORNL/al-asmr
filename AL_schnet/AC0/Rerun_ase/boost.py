...
tcoordinates,tforces,tcell,tenergies,tspecies,tvirial = ReadHDF5('iselected.h5',0)
#place holder
nframe= len(tcoordinates)
...
for i in range(0,nframe):
    for j in range(0,boostnum):
        coords = copy.deepcopy(tcoordinates[i])        
        if(j!=0):
            for ia in range(1,len(coords)):
        ...
        cell = np.append(cell,[tcell[i]],axis=0)
...
fname = 'selected.h5'
SaveHDF5(fname,coordinates,tr_f,tr_en,tspecies,cell,tr_virial)    
CheckHDF5(fname)
